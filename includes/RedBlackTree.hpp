...
/*   Updated: 2022/10/06 16:33:11 by abensett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	*******************************************************************************/
	...
	struct Node
	{
		...
		// Node constructor
		Node(const T& val) : value(val), parent(NULL), color(RED), left(NULL), right(NULL) {};
		// Node default constructor
		Node() : value(), parent(NULL), color(RED), left(NULL), right(NULL) {};
	};
